                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            @else
                                <p class="text-sm text-gray-500">No truck numbers available. Please create a truck number first.</p>
                            @endif
                            ...
                            <div class="mb-4">
                                ...
                                <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('truck_number') border-red-500 @enderror" 
                                        id="truck_number" 
                                        name="truck_number" 
                                        required>
                                    <option value="">Select Truck Number</option>
                                    @foreach($truckNumbers as $truckNumber)
                                        <option value="{{ $truckNumber->truck_number }}" {{ old('truck_number') === $truckNumber->truck_number ? 'selected' : '' }}>{{ $truckNumber->truck_number }}</option>
                                    @endforeach
                                </select>
